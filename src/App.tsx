...
const makeStyles = (dark) => ({
  ...
  card: { background: dark ? '#1e293b' : '#fff', padding: '24px', borderRadius: '20px', boxShadow: dark ? '0 1px 3px rgba(0,0,0,0.4)' : '0 1px 3px rgba(0,0,0,0.07)', border: `1px solid ${dark ? '#334155' : '#e2e8f0'}`, display: 'flex', flexDirection: 'column' },
  ...
  fileListWrap: { marginTop: '16px', flex: 1, background: dark ? '#0f172a' : '#f8fafc', border: `1px solid ${dark ? '#334155' : '#e2e8f0'}`, borderRadius: '14px', padding: '12px', maxHeight: '200px', overflowY: 'auto' },
