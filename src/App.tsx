...
const S = {
  page: { minHeight: '100vh', background: '#f8fafc', color: '#0f172a', fontFamily: 'Verdana, sans-serif', letterSpacing: '0.02em', lineHeight: 1.7, padding: '48px' },
  ...
  h1: { fontSize: '28px', fontWeight: 800, color: '#0f172a', display: 'flex', alignItems: 'center', gap: '12px', margin: 0 },
  subtitle: { marginTop: '8px', color: '#64748b', fontWeight: 500, fontSize: '15px' },
  tipBox: { background: '#eff6ff', color: '#1e40af', fontSize: '13px', padding: '12px 20px', borderRadius: '12px', border: '1px solid #bfdbfe', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 700 },
  grid2: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '32px', marginBottom: '32px' },
  card: { background: '#fff', padding: '24px', borderRadius: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.07)', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column' },
  cardTitle: { fontSize: '18px', fontWeight: 700, color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' },
  cardDesc: { color: '#64748b', fontSize: '13px', marginBottom: '16px' },
  ...
  fileListWrap: { marginTop: '16px', flex: 1, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '14px', padding: '12px', maxHeight: '200px', overflowY: 'auto' },
  emptyState: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px', color: '#94a3b8', minHeight: '120px' },
  fileItem: { background: '#fff', border: '1px solid #e2e8f0', padding: '10px 12px', borderRadius: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', boxShadow: '0 1px 2px rgba(0,0,0,0.04)' },
  fileIcon: { background: '#dbeafe', color: '#1d4ed8', padding: '8px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '10px', flexShrink: 0 },
  fileName: { fontWeight: 700, color: '#0f172a', fontSize: '13px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '180px' },
  fileSize: { fontSize: '11px', color: '#64748b', fontWeight: 500 },
  trashBtn: { background: 'transparent', border: 'none', cursor: 'pointer', color: '#94a3b8', padding: '6px', borderRadius: '6px', display: 'flex', alignItems: 'center' },
  runBtn: (disabled) => ({ background: disabled ? '#94a3b8' : '#0f172a', color: '#fff', fontWeight: 700, padding: '16px 48px', borderRadius: '999px', border: 'none', cursor: disabled ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '17px', fontFamily: 'Verdana, sans-serif', boxShadow: '0 4px 14px rgba(0,0,0,0.15)' }),
  center: { display: 'flex', justifyContent: 'center' },
  processingWrap: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 0' },
  processingTitle: { fontSize: '24px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' },
  processingMsg: { color: '#64748b', fontWeight: 500 },
  summaryCard: { background: '#fff', borderRadius: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.07)', border: '1px solid #e2e8f0', padding: '32px', marginBottom: '32px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '24px' },
  summaryTitle: { fontSize: '28px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' },
  statBox: { textAlign: 'center', padding: '16px', background: '#f8fafc', borderRadius: '14px', border: '1px solid #f1f5f9', minWidth: '120px' },
  ...
  sectionTitle: { fontSize: '22px', fontWeight: 700, color: '#0f172a', display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' },
  tabBar: { display: 'flex', gap: '8px', borderBottom: '1px solid #e2e8f0', marginBottom: '24px', overflowX: 'auto' },
  tab: (active, color) => ({ padding: '12px 24px', fontWeight: 700, border: 'none', borderBottom: active ? `2px solid ${color}` : '2px solid transparent', background: active ? (color === '#2563eb' ? '#eff6ff' : '#fff1f2') : 'transparent', color: active ? (color === '#2563eb' ? '#1e40af' : '#9f1239') : '#64748b', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontFamily: 'Verdana, sans-serif', fontSize: '14px', whiteSpace: 'nowrap', borderRadius: active ? '8px 8px 0 0' : 0 }),
  matchCard: { background: '#fff', borderRadius: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.07)', border: '1px solid #e2e8f0', overflow: 'hidden', marginBottom: '24px' },
  matchHeader: { background: '#f8fafc', padding: '16px 24px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  matchTitle: { fontWeight: 700, color: '#0f172a', fontSize: '17px' },
  badge: (isImage) => ({ display: 'inline-flex', alignItems: 'center', padding: '6px 14px', borderRadius: '999px', fontSize: '13px', fontWeight: 700, background: isImage ? '#fff1f2' : '#fef3c7', color: isImage ? '#9f1239' : '#92400e' }),
  ...
  previewWrap: { position: 'relative', width: '100%', background: '#f1f5f9', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', border: '1px solid #e2e8f0', minHeight: '220px', margin: '12px 0' },
  textBox: (isImage) => ({ marginTop: '12px', padding: '16px', border: `1px solid ${isImage ? '#fecdd3' : '#e2e8f0'}`, borderRadius: '12px', fontSize: '15px', lineHeight: 1.8, background: isImage ? '#fff1f2' : '#f8fafc', color: isImage ? '#9f1239' : '#0f172a' }),
  noResults: { background: '#fff', padding: '48px', borderRadius: '20px', border: '1px solid #e2e8f0', textAlign: 'center' },
  loadMoreWrap: { marginTop: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' },
  loadMoreBtn: { display: 'flex', alignItems: 'center', gap: '8px', background: '#fff', color: '#334155', fontWeight: 700, padding: '12px 32px', borderRadius: '999px', border: '2px solid #cbd5e1', cursor: 'pointer', fontFamily: 'Verdana, sans-serif', fontSize: '14px' },
  resetBtn: { display: 'flex', alignItems: 'center', gap: '8px', color: '#475569', fontWeight: 700, padding: '12px 32px', borderRadius: '999px', border: '2px solid #cbd5e1', background: '#fff', cursor: 'pointer', fontFamily: 'Verdana, sans-serif', fontSize: '14px' },
  modalOverlay: { position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(15,23,42,0.8)', padding: '32px' },
  modalBox: { position: 'relative', display: 'flex', flexDirection: 'column', maxHeight: '100%', maxWidth: '100%', background: '#f1f5f9', borderRadius: '16px', boxShadow: '0 25px 50px rgba(0,0,0,0.4)', overflow: 'hidden' },
  modalHeader: { background: '#fff', borderBottom: '1px solid #e2e8f0', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  ...
  fullscreenBtn: { position: 'absolute', top: '12px', right: '12px', padding: '8px', background: 'rgba(255,255,255,0.9)', color: '#334155', borderRadius: '8px', border: '1px solid #e2e8f0', cursor: 'pointer', display: 'flex', alignItems: 'center' },
};
    ...
    <div style={S.modalOverlay} onClick={onClose}>
      <div style={S.modalBox} onClick={e => e.stopPropagation()}>
        <div style={S.modalHeader}>
          <span style={{ fontWeight: 600, color: '#0f172a' }}>Page {pageNum} Preview</span>
          <button onClick={onClose} style={{ ...S.trashBtn, color: '#64748b' }}><X size={20} /></button>
        </div>
        <div style={S.modalBody}>
          {isRendering && <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748b', fontWeight: 500, background: '#f1f5f9' }}>Rendering high-quality page...</div>}
          <canvas ref={modalCanvasRef} style={{ maxWidth: 'none', boxShadow: '0 8px 24px rgba(0,0,0,0.15)', background: '#fff', opacity: isRendering ? 0 : 1, transition: 'opacity 0.3s' }} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <>
      <div style={S.previewWrap}>
        {isRendering && <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#64748b', fontSize: '13px', fontWeight: 500, background: '#f8fafc' }}>Rendering preview...</div>}
  ...
  const renderFileList = (files, setFiles) => {
    ...
    return files.map(fileItem => (
      <div key={fileItem.id} style={S.fileItem}>
        ...
        <button onClick={() => removeFile(fileItem.id, setFiles)} style={S.trashBtn} title="Remove file"><Trash2 size={16} /></button>
      </div>
    ));
  };
  ...
  const renderProcessingState = () => (
    <div style={S.processingWrap}>
      <div style={{ position: 'relative', width: '128px', height: '128px', marginBottom: '32px' }}>
        <svg style={{ width: '100%', height: '100%', color: '#dbeafe', animation: 'spin 1s linear infinite' }} viewBox="0 0 100 100">
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', fontWeight: 700, color: '#334155' }}>{progress.percent}%</div>
      </div>
      ...
      <div>
        ...
        <div style={S.summaryCard}>
          <div>
            ...
            <div style={{ color: '#64748b', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '12px' }}>
            <div style={S.statBox}>
              <div style={S.statLabel}>Context Matches</div>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#2563eb' }}>{textMatches.length}</div>
            </div>
            <div style={S.statBox}>
              <div style={S.statLabel}>Image Matches</div>
              <div style={{ fontSize: '28px', fontWeight: 800, color: '#e11d48' }}>{imageMatches.length}</div>
            </div>
        ...
        {displayMatches.length === 0 ? (
          <div style={S.noResults}>
            ...
            <div style={{ fontSize: '18px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>No {activeResultTab==='text'?'Context':'Image'} Duplicates Found</div>
            <div style={{ color: '#64748b', fontWeight: 500 }}>Group A documents appear to have no {activeResultTab==='text'?'textual':'visual'} overlaps with Group B records.</div>
          </div>
        ) : (
          <>
              ...
              return (
                <div key={idx} style={S.matchCard}>
                  ...
                  <div style={S.matchCols}>
                    {[
                      { group: 'Group A (Primary)', labelColor: '#1d4ed8', docName: match.docNameA, page: match.pageA, bg: '#eff6ff', border: '#bfdbfe', pillBg: '#2563eb', chunk: match.chunkA, pdfDoc: pdfDocA },
                      { group: 'Group B (Target)', labelColor: '#4338ca', docName: match.docNameB, page: match.pageB, bg: '#eef2ff', border: '#c7d2fe', pillBg: '#4f46e5', chunk: match.chunkB, pdfDoc: pdfDocB },
                    ].map(({ group, labelColor, docName, page, bg, border, pillBg, chunk, pdfDoc }, colIdx) => (
                      <div key={group} style={{ ...S.matchCol, borderRight: colIdx===0 ? '1px solid #e2e8f0' : 'none' }}>
                        ...
                        <PdfPagePreview pdfDoc={pdfDoc} pageNum={page} />
                        <div style={S.textBox(isImage)}>
                          {isImage ? (
                            ...
                            <><span style={{ display: 'block', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Overlapping text:</span><HighlightedText text={chunk} sharedWords={sharedWords} /></>
                          )}
                        </div>
                      </div>
                    ))}
    ...
    <div style={S.page}>
      <div style={S.wrap}>
        <header style={S.header}>
          ...
          {appState==='IDLE' && (
            <div style={S.tipBox}><AlertCircle size={20} style={{ flexShrink: 0 }} />Tip: Supports batch uploading and 2000+ page documents.</div>
          )}
        </header>
        <main>
